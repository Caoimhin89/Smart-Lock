...
for (const p of [new Alexa(), new GoogleAssistant()]) {
    ...
    describe(`PLATFORM: ${p.constructor.name} INTENTS` , () => {
        test('should return a LOCKED status at "LockIntent"', async () => {
        ...
        test('should return an UNLOCKED status at "LockIntent"', async () => {
            const conversation = testSuite.conversation();
...
let expectedLockPrompt = `Your door has been successfully locked.`;
let expectedUnlockPrompt = `Your door has been successfully unlocked.`;
